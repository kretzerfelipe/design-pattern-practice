...
describe("BuyStrategy Unit Tests", () => {
  it("não deve executar trade", () => {
    ...
    const currentOrder = new Order({} as Investor, 24.0, buyStrategy);
    ...
    buyStrategy.processMatch(mockStock, currentOrder);
  ...
  it("deve executar trade", () => {
    ...
    const currentBuyOrder = new Order({} as Investor, 24.0, buyStrategy);
    const waitingSellOrder = new Order({} as Investor, 24.0, sellStrategy);
    ...
    buyStrategy.processMatch(mockStock, currentBuyOrder);
